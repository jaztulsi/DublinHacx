...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Dublin Hacx — October 10, 2026" },
      { name: "description", content: "Dublin's very first Dublin Hacx — bring any idea, build it into reality. October 10, 2026 at Emerald High School." },
      { property: "og:description", content: "Dublin's very first Dublin Hacx — bring any idea, build it into reality. October 10, 2026 at Emerald High School." },
      { name: "twitter:description", content: "Dublin's very first Dublin Hacx — bring any idea, build it into reality. October 10, 2026 at Emerald High School." },
